...
describe('formatBomRows', () => {
  ...
  it('formats wall pattern customization', () => {
    const item: BOMItem = {
      ...baseItem,
      customization: { wallPatternEnabled: true, wallPattern: 'grid', lipStyle: 'normal', fingerSlide: 'none', wallCutout: { front: false, back: false, left: false, right: false }, height: 4 },
    };
  ...
  it('formats multiple customization fields', () => {
    const item: BOMItem = {
      ...baseItem,
      customization: { wallPatternEnabled: false, wallPattern: 'grid', lipStyle: 'reduced', fingerSlide: 'chamfered', wallCutout: { front: false, back: false, left: false, right: false }, height: 4 },
    };
